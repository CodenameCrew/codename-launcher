...
EngineContainer::EngineContainer(Engine* engine)
    : Button(0, 0, 400, 75, BACKGROUNDSECONDARYCOLOR)
{
	...
	spriteIcon = new Sprite(15, 7, LoadTexture(((std::string)(ASSETS_PATH "engine_icons/") + (std::string)(this->engine->iconPath)).c_str()));
	add(spriteIcon);
